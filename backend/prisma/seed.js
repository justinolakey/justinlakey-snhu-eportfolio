...
// initial seed data for 6 communities. Detailed specific data can be used for testing and demonstration
const communities = [
    {
...
// These are generated using a seeded random generator for development and testing

const NEW_CITIES = [
    // Texas (6 more, bringing TX to 12 total with the 6 above)
    { state: "TX", city: "Fort Worth", zip: "76123", lat: 32.6566, lng: -97.3308 },
    { state: "TX", city: "El Paso", zip: "79938", lat: 31.7619, lng: -106.2989 },
    { state: "TX", city: "Plano", zip: "75025", lat: 33.07, lng: -96.7836 },
    ...
    { state: "OK", city: "Bixby", zip: "74008", lat: 35.942, lng: -95.8833 },
    ...
    { state: "LA", city: "Lake Charles", zip: "70605", lat: 30.167, lng: -93.1771 },
    ...
    { state: "AR", city: "Jonesboro", zip: "72404", lat: 35.8423, lng: -90.677 },
    { state: "AR", city: "Conway", zip: "72034", lat: 35.0887, lng: -92.4421 },
    { state: "AR", city: "Rogers", zip: "72758", lat: 36.332, lng: -94.1185 },
...
const NAME_SUFFIXES = ["Estates", "Crossing", "Ranch", "Commons", "Heights", "Village", "Park", "Landing", "Pointe", "Trails", "Meadows", "Reserve"];
...
const AMENITIES = [
    ...
    "a fitness center and dog park",
    "green spaces and picnic areas",
    "a resort-style pool and splash pad",
];
const FEATURES = [
    "open-concept floor plans",
    "energy-efficient designs",
    "spacious primary suites",
    "modern kitchens with large islands",
...
const TIERS = [
    {
        weight: 0.3,
        priceMin: [220000, 270000],
        priceSpread: [80000, 140000],
        sqftMin: [1300, 1650],
        sqftSpread: [400, 700],
        lotMin: [4500, 5500],
        lotSpread: [800, 1500],
    ...
    {
        weight: 0.5,
        priceMin: [320000, 430000],
        priceSpread: [100000, 180000],
        sqftMin: [1800, 2300],
        sqftSpread: [500, 900],
        lotMin: [5500, 7000],
        lotSpread: [1000, 2000],
    ...
    {
        weight: 0.2,
        priceMin: [480000, 600000],
        priceSpread: [150000, 300000],
        sqftMin: [2600, 3200],
        sqftSpread: [600, 1000],
        lotMin: [7500, 9000],
        lotSpread: [1500, 4000],
